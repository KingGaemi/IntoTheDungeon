...
namespace IntoTheDungeon.Core.Runtime.ECS.Manager
{
    ...
    /// </summary>
    public sealed class EntityManager : Abstractions.IDisposable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool HasComponent<T>(Entity entity) where T : struct , Core.ECS.Components.IComponentData
        {
            if (!Exists(entity))
                return false;
        ...
        public ref T GetComponent<T>(Entity entity) where T : struct , Core.ECS.Components.IComponentData
        {
            if (!Exists(entity))
                throw new ArgumentException("Entity does not exist");
        ...
        public void SetComponent<T>(Entity entity, T component) where T : struct , Core.ECS.Components.IComponentData
        {
            GetComponent<T>(entity) = component;
        }

        public bool TryGetComponent<T>(Entity entity, out T component) where T : struct, Core.ECS.Components.IComponentData
        {
