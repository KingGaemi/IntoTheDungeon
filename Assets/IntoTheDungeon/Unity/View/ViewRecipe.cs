...
namespace IntoTheDungeon.Unity.View
{
    ...
    public sealed class ViewRecipe : ScriptableObject
    {
        ...
        [SerializeField] int _sortingLayerId;
        ...
        /// ViewSpawnSpec 생성
        /// </summary>
        public ViewSpawnSpec CreateSpawnSpec(ViewRecipeRegistry registry)
        {
    ...
    public static class ViewRecipeExtensions
    {
        ...
        {
            var spec = registry.CreateSpawnSpec(recipeId);
            queue.EnqueueSpawn(entity, in spec);
        }
    }
}